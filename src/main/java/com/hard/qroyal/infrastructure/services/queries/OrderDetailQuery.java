...
import com.hard.qroyal.infrastructure.repositories.OrderDetailRepository;
...
@Service
public class OrderDetailQuery extends BaseQuery<OrderDetail, OrderDetailRepository> implements OrderDetailService {
